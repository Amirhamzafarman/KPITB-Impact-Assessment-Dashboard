...
print(f"Generated {len(cube_records)} records in kpk_ecosystem_cube.json")

with open("/Users/hamza/Documents/KPITB/RTS/DIGITAL IMPACT/kpk_ecosystem_cube.json", "w", encoding="utf-8") as f:
    json.dump(cube_records, f)

print("✔ Saved kpk_ecosystem_cube.json successfully!")
